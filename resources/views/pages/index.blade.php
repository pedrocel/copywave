<x-app-layout>
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row justify-between items-center mb-4 space-y-4 md:space-y-0 md:space-x-4">
            ...
            <a href="{{ route('pages.create') }}" class="bg-gradient-to-r from-[#CC54F4] to-[#AB66FF] hover:bg-gradient-to-l text-white py-2 px-4 rounded">
                Criar Página
            </a>
        </div>
            ...
            @forelse($pages as $page)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="flex justify-between mt-4">
                        <a href="{{ route('pages.show', $page->name) }}" class="text-blue-500 hover:underline">Visualizar</a>
                        <a href="{{ route('pages.detail', $page->name) }}" class="text-blue-500 hover:underline">Detalhes</a>
