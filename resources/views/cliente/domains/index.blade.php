<x-app-layout>
    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('cliente.domains.create') }}" class="bg-gradient-to-r from-[#CC54F4] to-[#AB66FF] hover:bg-gradient-to-l text-white py-2 px-4 rounded">
                Adicionar Domínio
            </a>
        </div>
            ...
            @forelse($domains as $domain)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="flex justify-between mt-4">
                        <a href="{{ route('cliente.domains.edit', $domain->id) }}" class="text-blue-500 hover:underline">Editar</a>
                        <form action="{{ route('cliente.domains.destroy', $domain->id) }}" method="POST" class="inline-block">
                            @csrf
                            @method('DELETE')
