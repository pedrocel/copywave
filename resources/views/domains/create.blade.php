<x-app-layout>
    ...
    <div class="container mx-4">
        <form action="{{ route('domains.store') }}" method="POST" class="bg-white dark:bg-gray-800 p-6 shadow rounded-lg">
            @csrf
            ...
            <div class="flex justify-end">
                ...
                <a href="{{ route('domains.index') }}" class="ml-4 text-gray-600 dark:text-gray-400 hover:underline">
                    Cancelar
                </a>
            </div>
        </form>
